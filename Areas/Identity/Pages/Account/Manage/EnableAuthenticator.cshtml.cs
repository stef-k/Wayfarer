...
namespace Wayfarer.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(ApplicationUser user)
        {
            ...
            string username = user.UserName; // Get the username instead of email
        ...
        private string GenerateQrCodeUri(string username, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("Wayfarer"), // Issuer name (change "WayfarerApp" to your app's name)
                _urlEncoder.Encode(username),      // Use the username here
                unformattedKey);
        }
