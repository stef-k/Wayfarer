    ...
    public void Configure(EntityTypeBuilder<LocationEnrichmentAttempt> builder)
    {
        ...
        builder.ToTable(table =>
        {
            ...
            table.HasCheckConstraint("CK_LocationEnrichmentAttempt_OperationPair",
                "(\"OperationId\" IS NULL AND \"OperationLeaseId\" IS NULL AND \"OperationFencingGeneration\" IS NULL "
                ...
                + "AND \"CredentialGeneration\" > 0 AND \"ConfigurationGeneration\" > 0 AND \"SelectionGeneration\" > 0 "
