...
namespace Wayfarer.Migrations
{
    ...
    [Migration("20260824142258_CompleteLocationEnrichmentAuthorityConstraints")]
    partial class CompleteLocationEnrichmentAuthorityConstraints
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationSettings", b =>
                {
                    ...
                    b.Property<Guid?>("ActiveRoutingProviderConfigurationId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("TileTrafficMode")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Wayfarer.Models.Location", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ReverseGeocodedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("ReverseGeocodingProvider")
                        .HasMaxLength(24)
                        .HasColumnType("character varying(24)");

                    b.Property<string>("ReverseGeocodingStorageMode")
                        .HasMaxLength(16)
                    ...
                    b.ToTable("LocationEnrichmentAttempts", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_LocationEnrichmentAttempt_OperationPair", "(\"OperationId\" IS NULL AND \"OperationFencingGeneration\" IS NULL AND \"OperationStartedAtUtc\" IS NULL) OR (\"OperationId\" IS NOT NULL AND \"OperationFencingGeneration\" > 0 AND \"OperationStartedAtUtc\" IS NOT NULL AND \"NextAttemptAtUtc\" IS NOT NULL)");
            ...
            modelBuilder.Entity("Wayfarer.Models.LocationProviders.PersonalLocationProviderProfile", b =>
                {
                    ...
                    b.Property<bool>("GeocodingAuthorized")
                        .HasColumnType("boolean");

                    b.Property<int>("GeocodingGeneration")
                        .HasColumnType("integer");

                    b.Property<int>("GeocodingVerification")
                        .HasColumnType("integer");

                    b.Property<int?>("GeocodingVerifiedConfigurationGeneration")
                        .HasColumnType("integer");

                    b.Property<int?>("GeocodingVerifiedCredentialGeneration")
                        .HasColumnType("integer");

                    b.Property<int>("LegacyMigrationState")
                        .HasColumnType("integer");

                    b.Property<int?>("PermanentGeocodingConsentCredentialGeneration")
                        .HasColumnType("integer");

                    b.Property<int?>("PermanentGeocodingConsentVersion")
                        .HasColumnType("integer");

                    b.Property<DateTimeOffset?>("PermanentGeocodingConsentedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<bool>("RoutingAuthorized")
                        .HasColumnType("boolean");

                    b.Property<int>("RoutingGeneration")
                        .HasColumnType("integer");

                    b.Property<int>("RoutingVerification")
                        .HasColumnType("integer");

                    b.Property<int?>("RoutingVerifiedConfigurationGeneration")
                        .HasColumnType("integer");

                    b.Property<int?>("RoutingVerifiedCredentialGeneration")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Wayfarer.Models.LocationProviders.PersonalLocationProviderSelection", b =>
                {
                    ...
                    b.Property<int>("GeocodingSelectionGeneration")
                        .HasColumnType("integer");

                    b.Property<string>("RoutingProviderKey")
                        .HasMaxLength(24)
                        .HasColumnType("character varying(24)");

                    b.Property<int>("RoutingSelectionGeneration")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PersonalLocationProviderSelections", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_PersonalProviderSelection_Routing", "\"RoutingProviderKey\" IS NULL OR \"RoutingProviderKey\" IN ('geoapify', 'mapbox')");
                        });
                });
            ...
            modelBuilder.Entity("Wayfarer.Models.Place", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("AddressEnrichedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("AddressEnrichmentProvider")
                        .HasMaxLength(24)
                        .HasColumnType("character varying(24)");

                    b.Property<string>("AddressEnrichmentStorageMode")
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)");
            ...
            modelBuilder.Entity("Wayfarer.Models.RoutingProviderConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ExternalCoordinateDisclosure")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)");
                    ...
                    b.Property<int>("MinimumIntervalMilliseconds")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(1000);

                    b.Property<int>("PersonalRoutingAccess")
                        .HasColumnType("integer");

                    b.Property<int>("RequestsPerMinute")
                        .HasColumnType("integer");

                    b.Property<int>("ResponseSizeLimitBytes")
                        .HasColumnType("integer");
                    ...
                    b.Property<double?>("VerificationFromLatitude")
                        .HasColumnType("double precision");

                    b.Property<double?>("VerificationFromLongitude")
                        .HasColumnType("double precision");
                    ...
                    b.Property<double?>("VerificationToLatitude")
                        .HasColumnType("double precision");

                    b.Property<double?>("VerificationToLongitude")
                        .HasColumnType("double precision");

                    b.Property<int?>("VerifiedConfigurationVersion")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Wayfarer.Models.RoutingProviderProfileMapping", b =>
                {
                    b.Property<Guid>("RoutingProviderConfigurationId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("TransportProfileId")
                        .HasColumnType("uuid");

                    b.Property<string>("OsrmProfile")
                        .IsRequired()
                        .HasMaxLength(80)
                        .HasColumnType("character varying(80)");

                    b.HasKey("RoutingProviderConfigurationId", "TransportProfileId");
            ...
            modelBuilder.Entity("Wayfarer.Models.Segment", b =>
                {
                    ...
                    b.Property<int>("EstimatedDurationSource")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
                    ...
                    b.Property<string>("RouteAttribution")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<DateTimeOffset?>("RouteGeneratedAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<string>("RouteMappingMode")
                        .HasMaxLength(80)
                        .HasColumnType("character varying(80)");
                    ...
                    b.Property<Guid?>("RouteProviderConfigurationId")
                        .HasColumnType("uuid");

                    b.Property<int?>("RouteProviderConfigurationVersion")
                        .HasColumnType("integer");

                    b.Property<string>("RouteStorageMode")
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)");

                    b.Property<Guid?>("RouteTransportProfileId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Segments", t =>
                        {
                            t.HasCheckConstraint("CK_Segments_EstimatedDurationSource", "\"EstimatedDurationSource\" IN (0, 1)");
                        });
                });

            modelBuilder.Entity("Wayfarer.Models.SegmentWaypoint", b =>
                {
                    ...
                    b.Property<int?>("RouteVertexIndex")
                        .HasColumnType("integer");

                    b.HasKey("SegmentId", "PlaceId");
                    ...
                    b.HasIndex("SegmentId", "RouteVertexIndex")
                        .IsUnique()
                        .HasDatabaseName("IX_SegmentWaypoints_SegmentId_RouteVertexIndex")
                        .HasFilter("\"RouteVertexIndex\" IS NOT NULL");

                    b.ToTable("SegmentWaypoints", null, t =>
                        {
                            t.HasCheckConstraint("CK_SegmentWaypoint_Position", "\"Position\" >= 0");

                            t.HasCheckConstraint("CK_SegmentWaypoint_RouteVertexIndex", "\"RouteVertexIndex\" IS NULL OR \"RouteVertexIndex\" > 0");
                        });
                });
            ...
            modelBuilder.Entity("Wayfarer.Models.TransportProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<double?>("PlanningSpeedKmh")
                        .HasColumnType("double precision");
                    ...
                    b.ToTable("TransportProfiles", null, t =>
                        {
            ...
            modelBuilder.Entity("Wayfarer.Models.UserRoutingConfiguration", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("text");
                    ...
                    b.Property<Guid?>("SelectedProviderConfigurationId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("VerifiedProviderConfigurationVersion")
                        .HasColumnType("integer");

                    b.Property<int?>("VerifiedUserConfigurationVersion")
                        .HasColumnType("integer");

                    b.HasKey("UserId");

                    b.HasIndex("SelectedProviderConfigurationId");

                    b.ToTable("UserRoutingConfigurations", null, t =>
                        {
                            t.HasCheckConstraint("CK_UserRoutingConfigurations_CredentialConsistency", "(\"CredentialPresent\" AND \"CredentialCiphertext\" IS NOT NULL) OR (NOT \"CredentialPresent\" AND \"CredentialCiphertext\" IS NULL)");

                            t.HasCheckConstraint("CK_UserRoutingConfigurations_DefaultMode", "\"SelectedProviderConfigurationId\" IS NOT NULL OR (NOT \"CredentialPresent\" AND \"CredentialCiphertext\" IS NULL AND \"VerifiedUserConfigurationVersion\" IS NULL AND \"VerifiedProviderConfigurationVersion\" IS NULL AND \"VerificationStatus\" IS NULL)");

                            t.HasCheckConstraint("CK_UserRoutingConfigurations_VerifiedPair", "(\"VerifiedUserConfigurationVersion\" IS NULL AND \"VerifiedProviderConfigurationVersion\" IS NULL) OR (\"VerifiedUserConfigurationVersion\" IS NOT NULL AND \"VerifiedProviderConfigurationVersion\" IS NOT NULL)");

                            t.HasCheckConstraint("CK_UserRoutingConfigurations_Version", "\"ConfigurationVersion\" >= 1");
                        });
                });

            modelBuilder.Entity("ApplicationSettings", b =>
                {
                    b.HasOne("Wayfarer.Models.RoutingProviderConfiguration", "ActiveRoutingProviderConfiguration")
                        .WithMany()
                        .HasForeignKey("ActiveRoutingProviderConfigurationId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("ActiveRoutingProviderConfiguration");
                });
            ...
            modelBuilder.Entity("Wayfarer.Models.LocationProviders.GeoapifyUsageAdmission", b =>
                {
                    b.HasOne("Wayfarer.Models.LocationProviders.GeoapifyUsageGuard", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Wayfarer.Models.LocationProviders.GeoapifyUsageGuard", b =>
                {
                    b.HasOne("Wayfarer.Models.ApplicationUser", null)
                        .WithOne()
                        .HasForeignKey("Wayfarer.Models.LocationProviders.GeoapifyUsageGuard", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Wayfarer.Models.RoutingProviderProfileMapping", b =>
                {
                    b.HasOne("Wayfarer.Models.RoutingProviderConfiguration", "RoutingProviderConfiguration")
                        .WithMany("ProfileMappings")
                        .HasForeignKey("RoutingProviderConfigurationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Wayfarer.Models.TransportProfile", "TransportProfile")
                        .WithMany()
                        .HasForeignKey("TransportProfileId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("RoutingProviderConfiguration");
            ...
            modelBuilder.Entity("Wayfarer.Models.SegmentWaypoint", b =>
                {
                    ...
                    b.HasOne("Wayfarer.Models.Segment", "Segment")
                        .WithMany("Waypoints")
            ...
            modelBuilder.Entity("Wayfarer.Models.UserRoutingConfiguration", b =>
                {
                    b.HasOne("Wayfarer.Models.RoutingProviderConfiguration", "SelectedProviderConfiguration")
                        .WithMany()
                        .HasForeignKey("SelectedProviderConfigurationId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Wayfarer.Models.ApplicationUser", "User")
                        .WithOne()
                        .HasForeignKey("Wayfarer.Models.UserRoutingConfiguration", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SelectedProviderConfiguration");
