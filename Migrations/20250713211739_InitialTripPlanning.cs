        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    LocationTimeThresholdMinutes = table.Column<int>(type: "integer", nullable: false),
                    LocationDistanceThresholdMeters = table.Column<int>(type: "integer", nullable: false),
                    MaxCacheTileSizeInMB = table.Column<int>(type: "integer", nullable: false),
                    IsRegistrationOpen = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    UploadSizeLimitMB = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsTimelinePublic = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    PublicTimelineTimeThreshold = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TileLocation = table.Column<Point>(type: "geometry", nullable: false),
                    ...
                    TileFilePath = table.Column<string>(type: "text", nullable: true),
                    xmin = table.Column<uint>(type: "xid", rowVersion: true, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TileCacheMetadata", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastImportedRecord = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LocationImports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LocationImports_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Locations_ActivityTypes_ActivityTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LocationImports_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Locations_ActivityTypeId",
                table: "Locations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TileCacheMetadata_TileLocation",
