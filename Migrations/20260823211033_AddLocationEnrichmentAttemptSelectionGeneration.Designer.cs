...
namespace Wayfarer.Migrations
{
    ...
    [Migration("20260823211033_AddLocationEnrichmentAttemptSelectionGeneration")]
    partial class AddLocationEnrichmentAttemptSelectionGeneration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Wayfarer.Models.LocationEnrichment.LocationEnrichmentWorkflow", b =>
                {
                    ...
                    b.ToTable("LocationEnrichmentWorkflows", t =>
                        {
                            t.HasCheckConstraint("CK_LocationEnrichmentWorkflow_Counters", "\"ProcessedCount\" >= 0 AND \"EnrichedCount\" >= 0 AND \"SkippedCount\" >= 0 AND \"RetryableDeferredCount\" >= 0 AND \"PermanentlyDeferredCount\" >= 0 AND \"RemainingEligibleCount\" >= 0 AND \"AdmittedUsageCount\" >= 0");
