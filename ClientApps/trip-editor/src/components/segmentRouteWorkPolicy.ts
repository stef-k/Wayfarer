...
type SegmentRouteDraft = Pick<EditorSegmentDraft, 'route' | 'waypointPlaceIds'>;

/** Returns whether the current hidden aggregate can safely enter route work before #409. */
export const canMutateSegmentRoute = (draft: SegmentRouteDraft): boolean => draft.waypointPlaceIds.length === 0;
