# Wayfarer User Guide (Index)

Welcome to Wayfarer — a self‑hosted trip planning and personal location timeline app with optional mobile integration.
...
- [3 - Features Overview](03-Features.md)
- [4 - Trips](04-Trips.md)
