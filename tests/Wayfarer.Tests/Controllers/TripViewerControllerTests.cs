...
public class TripViewerControllerTests : TestBase
{
    ...
    public async Task View_ExplicitlyLoadsOrderedWaypointPlaces_ForPublicTrip()
    {
        ...
        var start = new Place { Id = Guid.NewGuid(), Region = region, RegionId = region.Id, UserId = trip.UserId, Name = "A", Location = new Point(1, 1) { SRID = 4326 } };
        var via = new Place { Id = Guid.NewGuid(), Region = region, RegionId = region.Id, UserId = trip.UserId, Name = "B", Location = new Point(2, 2) { SRID = 4326 } };
        var end = new Place { Id = Guid.NewGuid(), Region = region, RegionId = region.Id, UserId = trip.UserId, Name = "C", Location = new Point(3, 3) { SRID = 4326 } };
